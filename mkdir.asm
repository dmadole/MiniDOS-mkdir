...
start:      br    skipspc
          ...
          ; Build information
            ...
            db    'See github.com/dmadole/MiniDOS-mkdir for more info',0
...
dousage:    sep   scall                 ; if more than one argument
            dw    o_inmsg
            db    'USAGE: mkdir newdir',13,10,0
            sep   sret


          ; If we got a single argument, pass to O_MKDIR and that's it.

gotpath:    sep   scall                 ; call mkdir, return 0 if no error
            dw    o_mkdir
            lbnf  return

            sep   scall                 ; else output message
            dw    o_inmsg
            db    'ERROR: can not create directory',13,10,0
